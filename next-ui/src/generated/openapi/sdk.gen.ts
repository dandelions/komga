...
/**
 * Reset today's library scan file limit usage
 *
 * Required role: **ADMIN**
 */
export const komgaResetLibraryScanDailyFileLimitUsage = <ThrowOnError extends boolean = false>(options?: Options<ResetLibraryScanDailyFileLimitUsageData, ThrowOnError>): RequestResult<ResetLibraryScanDailyFileLimitUsageResponses, unknown, ThrowOnError, 'data'> => (options?.client ?? client).post<ResetLibraryScanDailyFileLimitUsageResponses, unknown, ThrowOnError, 'data'>({
    responseStyle: 'data',
    security: [{ scheme: 'basic', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
